...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        mineUpdated(choice1, choice2, state, handPos, currentPlayer);
        return 0;
    ...
    case baron:
        baronUpdated(choice1, state, handPos, currentPlayer);
        return 0;
    ...
    case tribute:
        tributeUpdated(state, handPos, currentPlayer, nextPlayer, tributeRevealedCards);
        return 0;

    case ambassador:
        ambassadorUpdated(choice1, choice2, state, handPos, currentPlayer);
        return 0;
...
//overloaded version for testing tribute, ought to be deleteable with no ill effects
int cardEffect_tribute(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int tributeRevealedCards[])
{
    int i;
    int j;
    int k;
    ...
    {                               //Boolean true for going to discard an estate
        ...
        while (card_not_discarded)
        {
            ...
            {                      //Found an estate card!
                ...
                add_estate = 0;         //don't recieve an estate
            }
...
int ambassadorUpdated(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
    ...
    //can't use the ambassador effect on the ambassador being played
...
int tributeUpdated(struct gameState *state, int handPos, int currentPlayer, int nextPlayer, int tributeRevealedCards[])
{
    ...
    else
    {
        for (int i = 0; i < 2; i++)
        {
            ...
            shuffleDeckIfEmpty(state, nextPlayer);
...
int mineUpdated(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
    ...
    if (choice2 > gold || choice2 < copper) //added card must be treasure
    {
        return -1;
    }
